...
![Python](https://img.shields.io/badge/Python_3.11%2B-3776AB?style=plastic&logo=python&logoColor=white)
...
**UPDATE (21 Dec):** Current structure has roughly 10 minutes inference latency for roughly 10000 videos and is too heavy for real-time updating. A Two-Tower architecture potentially improves the performance by using BGE-M3 to embed media data offline and a lightweight CNN as a real-time app sequence processor, though the detailed structure might change while investigating.
